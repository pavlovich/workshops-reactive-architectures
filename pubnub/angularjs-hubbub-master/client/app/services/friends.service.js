...
/*
 |--------------------------------------------------------------------------
 | Fetch the friends list from the (GitHub) server
 |--------------------------------------------------------------------------
*/
...
/*
 |--------------------------------------------------------------------------
 | Fetch who of the user friends are online now (PubNub's here_now service)
 |--------------------------------------------------------------------------
*/
...
/*
 |--------------------------------------------------------------------------
 | Expose the list of friends complete with presence info
 |--------------------------------------------------------------------------
*/
  var all = function(){
    ...
    /* Otherwise, we:
        ...
        - get their online status (creating a channel group to monitor that)
        - merge this info
        - create the array of friends info
        - store that in the service
        - subscribe to the newly created channel group with a handler to refresh when changed
        - return the newly calculated array
    */
    return $q
      .all([fetchFriends(), fetchOnlineFriends()])
      .then(function(data){
